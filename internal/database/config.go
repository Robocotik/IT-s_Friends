...
type AssetsReader interface {
	GetCathedras(bot *telego.Bot, msg telego.Message, identity *structures.Identity) []string
	GetCourses(bot *telego.Bot, msg telego.Message, identity *structures.Identity) []string
	GetFaculties(bot *telego.Bot, msg telego.Message, identity *structures.Identity) []string
	GetFilials(bot *telego.Bot, msg telego.Message) []string
	GetGroups(bot *telego.Bot, msg telego.Message, identity *structures.Identity) []string
}

type Reader interface {
	GetAllIds() ([]int64, error)
	GetFriendsFromId(userID int64) ([]structures.IFriendsShort, error)
	GetGroupByUID(bot *telego.Bot, msg telego.Message, identity *structures.Identity) string
}

type Updater interface {
	UpdateUser(bot *telego.Bot, msg telego.Message, identity structures.Identity, id int64) error
}

type Inserter interface {
	AddConnection(ctx context.Context, bot *telego.Bot, msg telego.Message, user_id int64, friend_id int64) error
	AddFriend(bot *telego.Bot, msg telego.Message, friend *structures.AskedFriend) (int64, error)
	AddUserId(bot *telego.Bot, msg telego.Message, id int64, nickname string) error
}
